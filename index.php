...
.masonry-filter-group .btn:focus,.masonry-filter-group button:focus{
  outline:0}
.nav-block-right li,.owl-dot,.social-btns li,.top-bar-nav li{
...
.arw-btn,.btn-default,h1,h2,h3,h4,h5,h6{
...
.arw-btn{
  ...
  position:relative;
  font-weight:500}
.arw-btn:before,.pause:after,.play:before{
  font-family:FontAwesome}
.section .section-heading,.section-three .section-heading{
  line-height:1;
  letter-spacing:2.4px;
  text-transform:uppercase}
.arw-btn:before{
...
.collection-sub-heading,.section-three .section-sub-heading,.slider-sub-heading{
  font-weight:400;
  font-family:Lora,serif}
.section-three .section-heading:after,.section-three .section-heading:before{
  position:absolute;
  width:500px;
  height:3px;
  right:0;
...
.section .section-sub-heading{
  ...
  z-index:2;
  position:relative}
.section .section-text,.ver-two-section-text{
  padding-top:55px;
  margin:0 auto;
  font-size:18px;
  max-width:750px}
...
::-o-input-placeholder{
  color:#6F6661!important;
  font-family:Lato,sans-serif}
#cssmenu ul ul li a,#cssmenu>ul>li>a,.masonry-filter-group button span,.nav-block-right li a{
  font-family:Poppins,sans-serif}
.pad-0{
  padding:0}
.pad-lft-0,.pad-lt-0{
...
.facebook,.google-plus,.linkedin,.pinterest,.twitter,.instagram{
  width:25px;
  height:25px;
  border-radius:50%}
.facebook .fa,.google-plus .fa,.linkedin .fa,.pinterest .fa,.twitter .fa ,.instagram{
  color:#FFF}
.facebook{
...
.masonry-filter-group button{
  ...
  border-radius:5px;
  background-color:transparent}
.masonry-filter-group button.active>span:after,.masonry-filter-group button:hover>span:after{
  transform:scale(1);
...
.masonry-filter-group button span{
  font-weight:600;
  text-transform:uppercase}
.masonry-filter-group button.active,.masonry-filter-group button:hover{
  color:#FFF;
  background-color:#739D52}
...
.cart-box li,.cart-price,.cart-title{
  padding-bottom:10px}
.cart-box.active{
...
@media(max-width:785px){
  #cssmenu.small-screen #menu-button.menu-opened:before,#cssmenu.small-screen #menu-button:before,#cssmenu.small-screen .submenu-button.submenu-opened{
    background:#739D52}
  #cssmenu>ul>li>a{
    padding:5px 25px}
...
.home-slider-bg,.page-banner,.top-products-main-block{
  background-size:cover;
  background-repeat:no-repeat}
@media(max-width:992px){
  .nav-bar .logo img{
...
.home-slider.owl-carousel .owl-item.active .slider-dtl{
  opacity:1}
.home-slider.owl-carousel .owl-item .slider-heading,.home-slider.owl-carousel .owl-item .slider-sub-heading{
  ...
  transition-delay:2s;
  opacity:0}
.home-slider.owl-carousel .owl-item.active .slider-heading,.home-slider.owl-carousel .owl-item.active .slider-sub-heading{
  opacity:1}
@media(max-width:767px){
  .slider-dtl{
    margin-top:70%}
...
.collection-main-block .container{
  ...
  outline:rgba(235,231,222,.7) solid 10px}
.collection-img img{
  width:100%}
.collection-dtl{
  position:relative;
...
.welcome-main-block .welcome-heading-block{
  padding-bottom:70px}
.welcome-main-block .welcome-heading,.welcome-main-block .welcome-sub-heading{
  color:#6F6661;
  font-family:'Great Vibes',cursive;
  font-weight:400;
...
.welcome-main-block .welcome-features-sub-heading{
  ...
  color:#739D52;
  text-shadow:.1px 1px 2px rgba(0,0,0,.5)}
.features-sub-heading,.our-features p{
  line-height:1.71;
  font-weight:400}
@media(max-width:992px){
  .welcome-main-block{
...
.products-main-block .section-three{
  padding-bottom:80px}
.products-main-block .section-heading:after,.products-main-block .section-heading:before{
  width:400px}
.store-nav{
  padding-bottom:100px}
.store-nav .btn{
  ...
  -moz-transition:all .4s ease;
  transition:all .4s ease}
.features-heading,.features-sub-heading{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
.store-nav .btn.active>span:after,.store-nav .btn.btn-active>span:after,.store-nav .btn:hover>span:after{
  transform:scale(1);
  transform-origin:bottom;
  animation:leaf-ani .8s ease}
...
.store-nav .btn:focus{
  outline:0}
.store-nav .btn.active,.store-nav .btn.btn-active,.store-nav .btn:hover{
  color:#FFF;
  background-color:#739D52}
...
.features-main-block .section-three{
  padding-bottom:100px}
.features-main-block .section-heading:after,.features-main-block .section-heading:before{
  width:370px}
.our-features{
  margin-bottom:42px}
.our-features-img{
...
.farmers-main-block .section-three{
  padding-bottom:90px}
.farmers-main-block .section-heading:after,.farmers-main-block .section-heading:before{
  width:355px}
.farmers-img{
  margin-bottom:40px;
...
.farmers-name{
  ...
  line-height:.5;
  text-shadow:.1px 1px 2px rgba(0,0,0,.5)}
.accor-widget .products-main-heading a,.copyright-text p,.farmers-dtl .farmers-post,.myaccount-widget ul li a,.news-read-more,.news-title a,.read-more,.useful-link-widget ul li a{
  font-family:Poppins,sans-serif}
.farmers-dtl .farmers-post{
  ...
  text-align:right;
  text-transform:uppercase}
.footer-menu ul li a,.news-title a,.sidebar-heading,.top-products-heading,.widget-heading{
  text-transform:uppercase}
...
.news-main-block .section-three{
  padding-bottom:100px}
.news-main-block .section-heading:after,.news-main-block .section-heading:before{
  width:340px}
.news-block{
  position:relative;
  margin-bottom:30px}
...
.news-block:hover .news-img img{
  ...
  z-index:1}
.contact-form .form-group i,.search-box i{
  top:50%;
  right:20px;
  transform:translateY(-50%)}
.news-post-block{
...
.news-info,.news-title{
  padding-bottom:5px}
.contact-form .btn-default,.top-selling-img{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.news-post-block p{
  padding-bottom:10px;
  line-height:1.86}
.about-widget p,.contact-form .form-control,.contact-form textarea{
  letter-spacing:.7px;
  line-height:1.93}
.news-read-more{
  color:#739D52;
...
.widget-heading{
  ...
  color:#6F6661;
  font-weight:700}
.myaccount-widget ul li,.useful-link-widget ul li{
  padding:5px 0}
...
.footer-menu ul li a{
  ...
  font-weight:500;
  letter-spacing:1.4px}
.footer-menu ul li a:hover,.search-box i{
  color:#739D52}
@media(max-width:767px){
  .widget-heading{
    padding-bottom:25px}
...
.accor-widget .panel{
  ...
  border:none;
  box-shadow:none}
.accor-widget .panel-heading,.accor-widget .sub-panel-heading+.panel-collapse>.panel-body{
...
.accor-widget .sub-panel .panel-title a:hover{
  color:#739D53}
.shop-panel .shop-widget-btn-down,.shop-panel .shop-widget-btn-plus{
  display:none}
.shop-panel .btn-default.shop-widget-btn-minus,.shop-panel .btn-default.shop-widget-btn-up,.shop-panel .collapsed .shop-widget-btn-down,.shop-panel .collapsed .shop-widget-btn-plus{
  display:inherit}
.shop-panel .shop-widget-btn-down,.shop-panel .shop-widget-btn-up{
  position:absolute;
  right:0;
  padding:1px 3px;
  border-radius:100%;
  ...
  color:#FFF;
  font-size:11px}
.shop-panel .collapsed .shop-widget-btn-down,.shop-panel .collapsed .shop-widget-btn-up{
  background-color:#6F6661;
  color:#FFF}
.shop-panel .shop-widget-btn-minus,.shop-panel .shop-widget-btn-plus{
  position:absolute;
  ...
  color:#6F6661;
  font-size:18px}
.shop-panel .collapsed .shop-widget-btn-minus,.shop-panel .collapsed .shop-widget-btn-up{
  display:none}
.shop-products-rating li,.shop-two-products-block li{
  display:inline-block}
...
.price-filter .ui-slider-handle.ui-state-default.ui-corner-all{
  ...
  background:#739D52;
  outline:0}
.sort-dropdown .dropdown-menu,.top-selling-img img{
  width:100%}
...
.top-selling-img{
  ...
  transition:all .5s ease}
.shop-products-dtl-main,.tag-widget .badge{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.dec.qtybutton,.inc.qtybutton{
  ...
  color:#6F6661;
  cursor:pointer}
.dec.qtybutton .fa,.inc.qtybutton .fa{
  line-height:.5}
.grid-icon .btn{
  width:40px;
  padding:0;
...
.grid-icon i{
  color:#6F6661;
  font-size:18px}
.grid-icon a.active,.grid-icon a:hover{
  background-color:#739D52}
.grid-icon a.active>i,.grid-icon a:hover>i{
  color:#FFF}
@media(max-width:992px){
  .shop-nav .pad-rt-0{
    padding-right:15px}
  .shop-nav .pad-lt-0{
    padding-left:15px}
  .shop-nav .product-display,.shop-nav .sort-btn{
    margin-bottom:30px}
}
@media(max-width:767px){
  .sidebar-widgets{
...
.shop-products-dtl-main{
  position:relative;
  transition:all .5s ease}
.shop-two-products-icon,.shop-two-products-img{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.shop-products-block:hover a,.shop-products-block:hover span{
  color:#6F6661}
...
.shop-products-name,.shop-products-rating{
  padding-bottom:0px}
.shop-products-name a{
  font-family:Lato,sans-serif}
.add-cart-btn a,.shop-three-products-name a{
  font-family:Poppins,sans-serif}
...
.shop-products-footer a{
  color:#6F6661}
.promo-text,.shop-two-promo-text{
  color:#FFF;
  text-transform:uppercase}
...
.shop-two-products-rating{
  ...
  right:0;
  margin:0 auto}
.price:after,.shop-two-products-name:after{
  left:50%;
  content:" "}
...
.shop-two-products-icon{
  ...
  background-color:#739D52;
  transition:all .5s ease}
.add-cart-btn,.shop-three-products-block{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.shop-three-products-block{
  margin-bottom:30px;
  transition:all .5s ease}
.shop-three-products-block:hover .shop-three-products-dtl,.shop-three-products-block:hover .shop-three-products-img{
  border-color:#739D52}
...
.shop-three-products-block:hover .add-cart-btn a{
  color:#FFF}
.shop-three-products-block .shop-products-rating i,.shop-three-products-name a:hover{
  color:#739D52}
.shop-three-products-img{
  position:relative;
  padding:70px 0;
  border:1px solid #EBE7DE}
.promo-text-three,.shop-three-promo-text{
  position:absolute;
  text-transform:uppercase;
  background-color:#739D52}
...
.add-cart-btn{
  border:1px solid #EBE7DE;
  transition:all .5s ease}
.product-gallery-slider .owl-next,.product-gallery-slider .owl-prev,.product-gallery-thumb{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.show-more-btn .btn-default{
  ...
  line-height:2.86;
  text-transform:none}
.add-address-text a,.add-cart-btn-two .btn-default,.cart-coupon-text,.cart-price,.cart-product-name,.cart-promo,.cart-table-one td,.coupon-apply-text,.list-products-block,.list-products-name a,.product-dtl-price,.product-dtl-tab .nav-tabs>li a,.products-origin{
  font-family:Poppins,sans-serif}
...
.list-products-icon li{
  ...
  padding:10px 14px;
  line-height:1.33}
.list-products-icon li:last-child:after,.product-detail-page .shop-two-products-block{
  display:none}
...
.rating-text{
  ...
  line-height:1.71}
@media(max-width:992px){
  .list-products-icon,.list-products-info{
    margin-bottom:30px}
}
.product-detail-page{
  padding-top:100px}
.product-detail-left-sidebar .shop-products-main-block li,.social-icon li{
  display:inline-block}
.product-detail-page .cart-plus-minus-box{
  width:32px}
.product-detail-page .dec.qtybutton,.product-detail-page .inc.qtybutton{
  margin-left:70px}
...
.product-gallery-slider .owl-next{
  right:0;
  padding-right:8px}
.product-gallery-slider .owl-next,.product-gallery-slider .owl-prev{
  position:absolute;
  z-index:10;
  top:0;
  width:25px;
  ...
  cursor:pointer;
  transition:all .5s ease}
.product-gallery-slider .owl-next i,.product-gallery-slider .owl-prev i{
...
.product-gallery-thumb{
  border:2px solid #EBE7DE;
  transition:all .5s ease}
.product-commitment-icon,.social-icon i{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.product-dtl-price{
  ...
  font-weight:600;
  line-height:1}
.product-desc,.product-detail-page .or-text{
  padding-bottom:15px}
...
@media(max-width:992px){
  ...
  .product-page-dtl-block .pad-lt-0{
    padding-left:15px}
  .product-page-dtl-block .product-display,.product-page-dtl-block .sort-btn{
    margin-bottom:15px}
  .purchase-features{
    border-right:none;
    border-bottom:1px solid #6F6661}
...
.related-products-heading{
  ...
  letter-spacing:2.4px;
  text-transform:uppercase}
.related-products-heading:after,.related-products-heading:before{
  position:absolute;
  width:500px;
  height:3px;
  bottom:-2px;
...
.product-commitment-icon{
  ...
  transition:all .5s ease}
.featured-product-slider .owl-next,.featured-product-slider .owl-prev,.why-register-block i{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.featured-product-slider .owl-next{
  right:15px}
.featured-product-slider .owl-next,.featured-product-slider .owl-prev{
  position:absolute;
  z-index:10;
  bottom:15px;
  width:20px;
...
.checkout-page-heading{
  ...
  line-height:1;
  letter-spacing:.6px}
.cart-total-heading,.checkout-form label{
  font-size:18px;
  line-height:1.33;
  font-weight:500}
.checkout-form label{
...
.payment input[type=radio]:checked:after{
  ...
  content:'';
  transform:translate(-50%,-50%)}
.cart-parent-page:after,.customer-name:after,.register-page-heading:after{
  content:" "}
.address-dtl-block{
  margin-bottom:20px;
  color:#000;
...
.cart-page .alert-success i{
  padding-right:20px}
.cart-page .dec.qtybutton,.cart-page .inc.qtybutton{
  margin-left:120px}
...
.coupon-apply-text{
  ...
  line-height:2.7;
  border-bottom:1px solid #000}
.register-heading,.why-register-heading{
  font-family:Lato,sans-serif}
...
.why-register-heading{
  ...
  color:#FFF;
  font-weight:500}
.about-me-block div,.recent-order-heading,.why-register-block li{
  font-family:Poppins,sans-serif}
...
.why-register-block i{
  padding-right:10px;
  transition:all .5s ease}
.faq-panel .btn-default,.insta-img{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.ac-nav li a{
  font-size:18px;
  font-weight:500}
.ac-nav li.active:after,.ac-nav li:hover>a:after{
  position:absolute;
  width:13px;
  height:17px;
  right:0;
...
.my-ac-wallet .btn-default,.order-history-table table{
  width:100%}
.ac-nav li.active{
  color:#739D52;
  font-size:18px}
...
.about-me-heading{
  ...
  font-weight:500;
  font-size:20px}
.blockquote-block,.recent-order-block{
  padding-bottom:50px}
.about-me-block p{
  color:#6F6661;
  font-style:italic}
...
.return-form,.wallet-page .register-form{
  box-shadow:none}
...
.wallet-text{
  ...
  color:#FFF;
  font-weight:500}
.blog-grid-dtl-heading a,.return-text,.testimonial-widget-block .client{
  font-family:Poppins,sans-serif}
.wallet-text span{
  font-weight:700}
.wallet-form{
...
#filename{
  ...
  overflow:hidden;
  background:#EBE7DE}
.faq-page .nav-tabs>li:hover,.faq-page .nav>li>a:focus,.faq-page .nav>li>a:hover{
  background-color:transparent}
@media(max-width:767px){
  .return-form.register-form,.wallet-page .register-form{
    margin-bottom:0}
  .return-form input[type=radio]{
    margin-right:2px}
}
...
.tabs-left>li{
  float:none}
.faq-page .nav-tabs>li.active>a,.faq-page .nav-tabs>li.active>a:focus,.faq-page .nav-tabs>li.active>a:hover{
  border:none;
  color:#739D52;
  font-weight:700}
.faq-page .nav-tabs,.faq-page .nav-tabs>li>a{
  border:none}
...
.blog-grid-dtl-heading a{
  ...
  -moz-transition:all .3s ease;
  transition:all .3s ease}
.blog-sidebar-heading,.twitter-user{
  font-weight:700;
  text-transform:uppercase}
.blog-grid-dtl-heading:hover{
  color:#739D52}
.blog-left-sidebar-main-block,.blog-right-sidebar-main-block{
  padding:100px 0}
...
.twitter-user{
  ...
  color:#000;
  margin-bottom:8px}
.twitter-user span,p.user-tweet{
  color:#6F6661}
p.user-tweet{
  font-weight:600;
  line-height:1.71;
...
.insta-img{
  ...
  overflow:hidden;
  transition:all .5s ease}
.insta-img .overlay-bg i,.insta-img img{
  margin:0 auto;
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
...
.archives-widget-block ul>li:hover>a{
  color:#739D52}
.archives-widget-block ul>li>a,.archives-widget-block ul>li>span{
  font-family:Lato,sans-serif;
  line-height:1.71;
  letter-spacing:.7px;
  color:#6F6661}
...
.sidebar-tabs li>a{
  ...
  font-weight:500;
  text-align:center}
.sidebar-tabs li.active a,.sidebar-tabs li.active a:focus,.sidebar-tabs li.active:focus a,.sidebar-tabs li.active:hover a{
  height:51px;
  margin-top:-5px;
...
.summer-slider .owl-next{
  right:10px}
.summer-slider .owl-next,.summer-slider .owl-prev{
  position:absolute;
  bottom:10px;
  width:20px;
  height:20px;
  ...
  -moz-transition:all .5s ease;
  transition:all .5s ease}
.blog-listing-heading,.blog-title{
  -webkit-transition:all .3s ease;
  text-transform:uppercase}
.summer-slider .owl-next:hover,.summer-slider .owl-prev:hover{
  background-color:#FFF;
  color:#739D52}
@media(max-width:767px){
  .blog-sidebar{
...
.blog-content .date span{
  ...
  margin:0;
  text-transform:uppercase}
.blog-content .meta-tags li,.blog-content .meta-tags li a{
  font-size:12px;
  font-weight:500;
  line-height:1.58;
  color:#6F6661}
...
.blog-content .meta-tags li{
  display:inline-block;
  margin-right:20px}
.blog-content .meta-tags li a:hover,.blog-title:hover{
  color:#739D52}
...
.blog-title{
  ...
  -moz-transition:all .3s ease;
  transition:all .3s ease}
.blog-slider-post .owl-next,.blog-slider-post .owl-prev,.share-btns ul>li>a>.fa{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
.blog-slider-post .owl-next{
  right:0}
.blog-slider-post .owl-next,.blog-slider-post .owl-prev{
  color:#FFF;
  font-size:30px;
  position:absolute;
  top:50%;
  ...
  cursor:pointer;
  transition:all .5s ease}
.blog-slider-post .owl-next:hover,.blog-slider-post .owl-prev:hover{
  background-color:#739D52;
  color:#FFF}
...
.video-device{
  position:relative}
.video-item .video-preview,.video-item .video-preview iframe,.video-item .video-preview-two,.video-item .video-preview-two iframe{
  width:100%;
  height:100%}
.video-preview{
  position:absolute;
...
.blog-comment .media-heading-block,.comments-heading,.grid .grid-item,.topic-heading{
  position:relative}
.blockquote-block{
  margin-bottom:50px;
  border-bottom:1px solid #EBE7DE}
...
.block-quote .fa{
  ...
  color:#739D52;
  margin-bottom:9px}
.block-quote .text,.block-quote-info .client-info{
  color:#6F6661;
  font-family:Lato,sans-serif;
  font-style:italic}
.block-quote .text{
...
.block-quote-info .client-info{
  font-weight:600}
.load-more-btn,.topic-block .breadcrumb li a{
  font-family:Poppins,sans-serif}
ul.blog-pagintaion li{
  display:inline-block}
a.pagi-btn-nxt,a.pagi-btn-pre{
  background-color:#000;
  color:#FFF;
  padding:2px 14px;
  border-radius:0;
  line-height:1.5}
a.pagi-btn-nxt:hover,a.pagi-btn-pre:hover{
  background-color:#739D52;
  color:#FFF}
a.pagi-btn-pre .fa{
  padding-right:5px}
...
ul.blog-pagintaion>li>a{
  ...
  color:#2C3E50;
  border-radius:5px}
ul.blog-pagintaion>li.active>a,ul.blog-pagintaion>li>a:hover{
  background-color:#739D52;
  color:#FFF}
@media(max-width:992px){
  .blog-content .meta-tags{
...
.blog-comment{
  margin-bottom:16px}
.blog-comment .media-heading,.blog-comment .media-heading-reply{
  font-size:16px;
  font-weight:600;
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
...
.blog-comment .media-heading span{
  color:#739D52}
.blog-comment .media-heading span,.blog-comment .media-heading-reply span{
  font-family:Lato,sans-serif;
  font-style:14px;
  font-weight:400;
  -webkit-transition:all .5s ease;
  ...
  -moz-transition:all .5s ease;
  transition:all .5s ease}
.blog-single-post-audio #pButton,.welcome-block-icon img{
  -webkit-transition:all .5s ease;
  -ms-transition:all .5s ease;
  -o-transition:all .5s ease;
  -moz-transition:all .5s ease}
...
@media(max-width:992px){
  .blog-user-profile,.special-block{
    padding-right:20px}
  .outline-50 .container{
    transform:translateY(0)}
  .blog-user-detail{
...
.blog-single-with-video{
  padding-bottom:150px}
.gallery-grid-main-block,.masonry-main-block{
  padding:100px 0}
...
.blog-single-post-audio #timeline{
  ...
  height:10px;
  background:#FFF}
.comming-soon-page,.error-404-page,.shipping-block{
  background-size:cover;
  background-repeat:no-repeat}
...
.blog-single-post-audio .pause:after{
  ...
  font-family:FontAwesome;
  font-size:34px}
.contact-us-form label,ul.contact-list li.tel a{
  font-family:Poppins,sans-serif}
@media(max-width:767px){
  .blog-single-post-audio #audioplayer{
    position:absolute;
...
.gallery-grid-block,.gallery-masonry-block{
  position:relative}
.gallery-grid-block img,.gallery-masonry-block img{
  width:100%}
.gallery-grid-block{
  display:none;
  margin-bottom:20px}
.gallery-grid-block .overlay-bg,.gallery-masonry-block .overlay-bg{
  -webkit-transform:scale(0);
  -moz-transform:scale(0);
  -ms-transform:scale(0);
  -o-transform:scale(0);
  transform:scale(0);
  background-color:rgba(115,157,82,.3)}
.gallery-grid-block a,.gallery-masonry-block a{
  position:absolute;
  top:50%;
  color:#FFF;
  font-size:52px;
  ...
  right:0;
  transform:translateY(-50%)}
.gallery-grid-block a:focus,.gallery-masonry-block a:focus{
  outline:0}
.gallery-grid-block a:hover,.gallery-masonry-block a:hover{
  transform:translateY(-50%) rotate(90deg)}
.gallery-grid-block:hover .overlay-bg,.gallery-masonry-block:hover .overlay-bg{
...
.contact-us-form label{
  ...
  font-weight:500;
  line-height:3}
.appointment-heading,.btn-lt-green{
  font-family:Poppins,sans-serif;
  font-weight:600}
...
.appointment-block{
  padding:50px;
  border:1px solid #EBE7DE}
.comming-soon-page:after,.error-404-page:after{
  border-top:2px solid #739D52;
  border-bottom:2px solid #739D52}
.comming-soon-page:before,.error-404-page:before{
...
.appointment-block .arw-btn:before{
  right:-25px}
.contact-us-map .map-banner,.contact-us-page .map-banner{
  width:100%;
  height:500px}
@media(max-width:992px){
  .contact-us-main-block{
...
.error-404-page{
  ...
  z-index:1}
.error-404-page:after,.error-404-page:before{
  position:absolute;
  content:"";
  top:50%;
  left:50%;
...
.comming-soon-page{
  ...
  z-index:1}
.comming-soon-page:after,.comming-soon-page:before{
  position:absolute;
  content:"";
  top:50%;
  left:50%;
...
.comming-soon-page .counter-col-days{
  ...
  font-size:72px;
  line-height:.83}
.comming-soon-page .count-days,.comming-soon-page .count-hours,.comming-soon-page .count-minutes{
  position:relative;
  padding-left:37px;
  padding-right:37px}
.count-seconds{
  position:relative;
  padding-left:37px}
.comming-soon-page .count-days:before,.comming-soon-page .count-hours:before,.comming-soon-page .count-minutes:before,.comming-soon-page .count-seconds:before{
  position:absolute;
  top:60px;
  font-size:48px;
  color:#3A3A3A;
...
.comming-soon-page .counter-col{
  ...
  font-size:72px;
  line-height:.83}
.deal-heading,.deal-price{
  font-family:Lora,serif}
.comming-soon-page .error-notify-block{
  margin-top:148px}
@media (max-width:767px){
  .comming-soon-page .count-days,.comming-soon-page .count-days:before,.comming-soon-page .count-hours,.comming-soon-page .count-hours:before,.comming-soon-page .count-minutes,.comming-soon-page .count-minutes:before,.comming-soon-page .count-seconds,.comming-soon-page .count-seconds:before,.comming-soon-page .counter-col,.comming-soon-page .counter-col-days{
    font-size:30px}
}
@media (max-width:992px){
  .comming-soon-page .count-days,.comming-soon-page .count-hours,.comming-soon-page .count-minutes{
...
.welcome-pdt-name:after{
  ...
  background-color:#6F6661;
  content:" "}
.welcome-block-text a,.welcome-block-text div{
  color:#6F6661;
  font-size:18px;
  font-weight:500;
  font-style:italic;
...
.offer-img-block-two:before,.offer-img-block:before{
  border-top:2px solid #FFF;
  border-bottom:2px solid #FFF}
.offer-img-block-two:after,.offer-img-block:after{
...
.deal-main-block .counter-col-days{
  display:none}
.deal-main-block .count-hours,.deal-main-block .count-minutes,.deal-main-block .count-seconds{
  position:relative;
  padding-left:10px;
  font-weight:500;
  font-family:Lora;
  padding-top:3px}
.deal-main-block .count-hours:after,.deal-main-block .count-minutes:after,.deal-main-block .count-seconds:after{
  position:absolute;
  top:0;
  left:60%;
  transform:translateX(-50%);
...
.offer-img-bg img{
  width:100%}
.offer-img-block-two:after,.offer-img-block-two:before,.offer-img-block:after,.offer-img-block:before{
  content:"";
  width:90%;
  top:50%;
  left:50%;
  transform:translate(-50%,-50%)}
.offer-img-block,.offer-img-block-two{
  position:relative}
      ...
      <div class="fresh-flavour-block welcome-main-block">
        <div class="row">
          <div class="col-md-6">
            ...
            <p>We have an established advanced infrastructure. Our processing unit is installed with latest machines and innovative tools so that the products are manufactured with utmost ease. 
              These machines are regularly serviced for hassle-free operations and are upgraded in compliance with the prevailing technological advancement. 
              Moreover, we also ensure that all the processes are completed at our infrastructure in a hassle free manner.</p>
            <p>As we are quality centric firm, we make all our efforts to maintain consistent quality of our 
              <em><strong>CALSIPHOS BIO NPK, ORGANIC MANURE, PROM, MAGNESIUM SULPHATE, BENTONITE SULPHAR 90%, MICRONUTRIENTS, ZYME</strong></em> etc. To ensure optimum quality of the products, we have established an advanced quality testing unit that is facilitated with latest testing tools. Also, our quality controllers test the entire product range at every stage, right from the procurement of raw material to final dispatch. We conduct quality test on different parameter to ensure the quality of the products before supplying to the clients.</p>
          ...
          <div class="col-md-12">
            ...
            <ul class="about-ul-s">
              ...
              <li>We shall establish a quality management system and work to continuously improve the system.</li>
